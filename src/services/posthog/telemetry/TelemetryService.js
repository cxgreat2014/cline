...
export class TelemetryService {
	 ...
	 */
	captureTaskCreated(taskId, uuid, apiProvider) {
		this.capture({
	 ...
	 * @param apiProvider Optional API provider
	 */
	captureTaskRestarted(taskId, uuid, apiProvider) {
		this.capture({
	 ...
	 */
	captureTaskCompleted(taskId, uuid) {
		this.capture({
	 ...
	 */
	captureConversationTurnEvent(taskId, uuid, provider = "unknown", model = "unknown", source, tokenUsage = {}) {
